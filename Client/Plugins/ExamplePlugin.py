...
programatic safety as well as usability. they are as follows:
...
is identicle to the python list syntax
6. The plugin must implement the method getName which returns a string. No other implementations are necessary.
NOTE: your plugin will raise an exception if another plugin tries to pass it a message and the addMessage method is not
implemented
'''
